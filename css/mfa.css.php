...
$color_start = '#' . getDolGlobalString('MFA_COLOR_START', '667eea');
$color_end = '#' . getDolGlobalString('MFA_COLOR_END', '764ba2');
...
background: linear-gradient(135deg, <?php echo $color_start; ?> 0%, <?php echo $color_end; ?> 100%);
border-radius: 16px;
...
.mfa-user-info { background: #f8f9ff; border-left: 4px solid <?php echo $color_start; ?>; padding: 16px; border-radius: 8px; margin-bottom: 24px; }
.mfa-user-info strong { display:block; color:#333; margin-bottom:4px; font-size:14px; }
.mfa-user-info span { color:<?php echo $color_start; ?>; font-size:16px; font-weight:600; }
...
.mfa-form-group input[type="text"]:focus { outline:none; border-color:<?php echo $color_start; ?>; box-shadow:0 0 0 4px rgba(102,126,234,0.1); background:#f8f9ff; }
.mfa-form-group input::placeholder { letter-spacing:2px; opacity:0.5; }

.mfa-buttons { display:flex; gap:12px; margin-top:24px; }
.mfa-btn-submit { flex:1; padding:12px 24px; background: linear-gradient(135deg,<?php echo $color_start; ?> 0%,<?php echo $color_end; ?> 100%); color:white; border:none; border-radius:10px; font-size:16px; font-weight:600; cursor:pointer; transition:all 0.3s ease; box-shadow:0 4px 15px rgba(102,126,234,0.3);color:white !important; }
...
.mfa-setup-secret {
background: #f8f9ff;
border-left: 4px solid <?php echo $color_start; ?>;
padding: 12px 14px;
border-radius: 8px;
text-align: center;
}
